...
//Timeout values
#define NOLINE_TIMEOUT 3000 // 5s
#define TURN_TIMEOUT 2000 //For the 𝛑 rad turn, 1s
...
#define DRIVE_SPD   170 //regular drive speed
...
#ifdef DST_SENSOR
#define DST_SNSR_TRIG_PIN  2 
#define DST_SNSR_ECHO_PIN	 3
#define MIN_DIST  5 //In cm
#endif
...
//Light/color sensors
#define 	LGT_SNSR_LFT_L	3
#define   LGT_SNSR_LFT  5
#define 	LGT_SNSR_RGT	4
#define   LGT_SNSR_RGT_R  2
